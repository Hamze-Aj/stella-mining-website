    ...
    <div className="bg-white p-8 rounded-lg shadow-md">
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div>
          ...
          {fileName && (
            <div className="mb-4 flex items-center space-x-2 p-3 bg-gray-50 rounded-lg border border-gray-300">
              <HiDocumentText className="text-accent text-2xl" />
          ...
          <p className="mt-1 text-sm text-gray-500">
            {document?.file_url ? 'Select a new file to replace the current one, or leave empty to keep current file.' : 'Upload a PDF or document file'}
          </p>
        </div>
